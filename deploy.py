...
def deploy_agent():
    ...
    requirements = ["google-cloud-aiplatform[agent_engines,adk]==1.151.0","google-adk[agent-identity]==1.32.0","httpx==0.28.1", "cloudpickle", "pydantic"]
    ...
    try:
        if target_agent:
            ...
            print("Rerun this deployment after setting necessary roles")
